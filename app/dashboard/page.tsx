    ...
    <header className="mb-12 flex items-center justify-between rounded-[24px] border border-black/8 bg-white/70 px-8 py-5 shadow-[0_12px_40px_rgba(25,20,90,0.06)] backdrop-blur-md transition-all duration-300">
      <Link href="/" className="flex items-center gap-2 group">
        <Image
          ...
          width={180}
          height={60}
          className="h-auto w-auto max-h-[60px] max-w-[180px] object-contain transition-transform duration-300 group-hover:scale-105"
        />
      </Link>
...
function QLogo() {
  return (
    <Image
      ...
      width={280}
      height={90}
      className="h-auto w-auto max-h-[90px] max-w-[280px] object-contain"
    />
  );
}
