    ...
    <main className="min-h-screen bg-[#050712] text-[#e9ecff]">
      ...
      <section className="mx-auto max-w-5xl px-6 py-10 md:py-14">
        <div className="space-y-8 text-sm leading-8 text-slate-200 md:text-base">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">Paper Trading and Simulated Data</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">Use of Third-Party Services</h2>
